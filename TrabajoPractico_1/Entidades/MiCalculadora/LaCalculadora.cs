...
namespace MiCalculadora
{
    public partial class LaCalculadora : Form
    {
        ...
        {
            if (!lblResultado.Text.Contains(",") && !lblResultado.Text.Contains("-") && !lblResultado.Text.Contains(""))
            {
        ...
        private void btnConverADecimal_Click(object sender, EventArgs e)
        {
            if (!lblResultado.Text.Contains(",") && !lblResultado.Text.Contains("-") && !lblResultado.Text.Contains(""))
            {
                 ...
                 lblResultado.Text = Convert.ToString(num1.BinarioDecimal(lblResultado.Text));
            }
            else
                MessageBox.Show("No se puede convertir el resultado a decimal.");
        }
        ...
        private void btnOperar_Click(object sender, EventArgs e)
        {
            ...
            lblResultado.Text = Convert.ToString(Math.Round(result, 2));
        }
        ...
        private double Operar(string numero1,string numero2,string operador)
        {
            ...
            if (numero2 == "0" && operador == "/")
            {
                ...
                return calcu.OperarCalculadora(num1, num2, operador);
        }
